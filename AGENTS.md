...
- When expected files legitimately need updating (e.g. a new feature adds new expected output), use the `RegenExpected` tool or formatter library directly — do not hand-write expected output. Hand-written expected files have been wrong before.
